...
<center>
    <div>
        ...
        <button v-on:click="hello()">Json Parser</button> -->
    </div>
</center>
</template>
<script>
import JsonParserVue from './JsonParser.vue'
    export default {
        name:'Home',
        components:{
            JsonParserVue,
